...
box1:set_texture('textures/crate1_diffuse.png')
box1:set_bumpmap('bumps/crate1_bump.png')
...
floor:scale(room_width*2, 1, room_length*2)
...
back_wall:scale(room_width*2, 1.0, room_height)
...
-- on ceiling
light1 = gr.disc_light({-5, room_height - 3, -room_length/2.0}, light_color, {1, 0, 0}, {0.0, -1.0, 0.0}, 5.0)
